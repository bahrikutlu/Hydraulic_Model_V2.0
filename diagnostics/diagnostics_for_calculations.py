...
pressure_drop = pressure_drop_calculator(yield_stress_tao_y,consistency_index_k,fluid_behavior_index_m,flow_rate_q,mud_density,eccentricity_e,conduit_type,hole_size,pipe_od,pipe_id, tool_joint_od)
